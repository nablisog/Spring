...
public class EmailConstant {
    ...
    public static final String USERNAME = "JustMadeUp@gmail.com";
    public static final String PASSWORD = "JustMadeUp";
    public static final String FROM_EMAIL = "JustMadeUp@gmail.com";
