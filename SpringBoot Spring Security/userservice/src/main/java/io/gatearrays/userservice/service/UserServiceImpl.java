...
import io.gatearrays.userservice.repo.RoleRepo;
import io.gatearrays.userservice.repo.UserRepo;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public Role saveRole(Role role) {
        log.info("saving new {} to database", role.getName());
    ...
    public User getUser(String username) {
        log.info("finding user  {} to by username", username);
